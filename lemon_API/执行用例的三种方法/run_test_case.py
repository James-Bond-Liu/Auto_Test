...
import unittest
from 执行用例的三种方法.test_case import TestMathMethod1
...
with open('test_report.html','wb') as file:
    runner3=HTMLTestRunnerNew.HTMLTestRunner(stream=file, verbosity=2,title='测试报告',description='第一次单元测试报告',tester='刘菲')
    runner3.run(suite3)
...
from 执行用例的三种方法.test_case import TestMathMethod1
from 执行用例的三种方法.test_case import TestMathMethod2
