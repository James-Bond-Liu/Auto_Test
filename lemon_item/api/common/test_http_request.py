...
import unittest
from lemon_item.api.common.http_request import HttpRequest
from lemon_item.api.common.do_excel import DoExcel
from ddt import ddt, data
from lemon_item.api.common.get_variable import GetVariable
from lemon_item.api.common.do_mysql import DoMysql
from lemon_item.api.common.do_logging import Dologging
...
class TestHttpRequest(unittest.TestCase):
    ...
    def test_api(self, item):
        ...
        try:
            ...
            DoExcel().write_back(r'/api\test_data\test_data.xlsx', 'login',
