...
from 基础语法.api.数据处理.测试用例参数化.ddt_unitest_excel.test_case import TestHttp
...
with open('test_suite.html','wb') as file:
    runner=HTMLTestRunnerNew.HTMLTestRunner(stream=file, verbosity=2,title=None,description=None)
    runner.run(suite)